...
func createRepository(t *testing.T, organization, project, name string) (repo Repository) {
	repo, err := NewRepositoryWithOrganization(organization, project, name)
	if err != nil {
...
func Test_Remotes_FindByName(t *testing.T) {
	...
	require.Error(t, err, "no GitHub remotes found")
}
...
func Test_FilterByHosts(t *testing.T) {
	...
	list := RemoteSet{r1, r2, r3}
	f := list.FilterByOrganization("DEFAULTORG", "ORG")
