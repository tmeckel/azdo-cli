...
//
//	mockgen -package=mocks -destination internal/mocks/build_client_mock.go -mock_names Client=MockBuildClient github.com/microsoft/azure-devops-go-api/azuredevops/v7/build Client
//
