...
//
//	mockgen -package=mocks -destination internal/mocks/work_client_mock.go -mock_names Client=MockWorkClient github.com/microsoft/azure-devops-go-api/azuredevops/v7/work Client
//
