...
//
//	mockgen -package=mocks -destination internal/mocks/core_client_mock.go -mock_names Client=MockCoreClient github.com/microsoft/azure-devops-go-api/azuredevops/v7/core Client
//
