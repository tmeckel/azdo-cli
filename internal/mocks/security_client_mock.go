...
//
//	mockgen -package=mocks -destination internal/mocks/security_client_mock.go -mock_names Client=MockSecurityClient github.com/microsoft/azure-devops-go-api/azuredevops/v7/security Client
//
